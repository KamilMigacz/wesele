(function($) {
    ...
    if ($("#clock").length) {
        $('#clock').countdown('2019/07/13', function(event) {
            ...
            + '<div class="box"><div>%D</div> <span>Dni</span> </div>'
            + '<div class="box"><div>%H</div> <span>Godzin</span> </div>'
            + '<div class="box"><div>%M</div> <span>Minut</span> </div>'
            + '<div class="box"><div>%S</div> <span>Sekund</span> </div>'));
        });
    }
